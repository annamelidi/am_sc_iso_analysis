...
if (!dir.exists("data")) {
  dir.create("data")  # Create the 'data' directory if it doesn't exist
}
...
ggsave(filename = "/Users/annamelidi/Documents/DTU_courses/Special_courses/DTU_Health/images/GCM/VariableFeatures.jpeg" )
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/GCM/DimHeatmap.jpeg", plot = last_plot(), device = "jpeg")


# Determine dimensionality of the data
ElbowPlot(seu_1,  reduction = "gpca") # After considering the elbow plot choose around 10 dimensions
ggsave(filename = "/Users/annamelidi/Documents/DTU_courses/Special_courses/DTU_Health/images/GCM/ElbowPlot.jpeg" )
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/GCM/cluster_tree.jpeg", plot = last_plot(), device = "jpeg", width = 10 , height = 10, dpi = 300)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/GCM/PCA_snn_res.2.jpeg", plot = last_plot(), device = "jpeg")
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/GCM/umap_free_annot.jpeg", plot = last_plot(), device = "jpeg", height = 10, width = 10)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/GCM/umap_res_2.jpeg", plot = last_plot(), device = "jpeg")
...
#ggsave(filename = "/Users/annamelidi/Documents/DTU_courses/Special_courses/DTU_Health/images/ICM/VariableFeatures.jpeg" )
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/ICM/DimHeatmap.jpeg", plot = last_plot(), device = "jpeg")

# Determine dimensionality of the data
ElbowPlot(seu_1,  reduction = "ispca") # After considering the elbow plot shoose around 10 dimensions
ggsave(filename = "/Users/annamelidi/Documents/DTU_courses/Special_courses/DTU_Health/images/ICM/elbow.jpeg" )
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/ICM/cluster_tree.jpeg", plot = last_plot(), device = "jpeg", width=9, height=9, dpi=300)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/ICM/PCA_snn_res.1.2.jpeg", plot = last_plot(), device = "jpeg",  width=9, height=9, dpi=300)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/ICM/umap_res2.jpeg", plot = last_plot(), device = "jpeg", width = 10 , height = 10)

plot_gt <- DimPlot(seu_1, reduction = "umap.iso",
                   group.by = "active.ident",
                   label = FALSE, repel = TRUE, alpha = 0.5)
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/ICM/umap_ann2.jpeg", plot = last_plot(), device = "jpeg", width = 10 , height = 10)
...
#ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/ICM/umap.jpeg", plot = last_plot(), device = "jpeg")
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/G+Iso/cluster_tree.jpeg", plot = last_plot(), device = "jpeg", width = 10 , height = 10, dpi = 300)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/G+Iso/umap_res.2.jpeg", plot = last_plot(), device = "jpeg")

plot <- DimPlot(seu_1, reduction = 'gene.iso.umap', group.by = 'active.ident', label = FALSE, repel = TRUE, alpha = 0.5) 

ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/G+Iso/umap_annot_res.2.jpeg", plot = last_plot(), device = "jpeg", height = 10, width = 10)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/G+Iso+IsoFr/cluster_tree.jpeg", plot = last_plot(), device = "jpeg", width = 10 , height = 10, dpi = 300)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/G+Iso+IsoFr/umap_res_2.jpeg", plot = last_plot(), device = "jpeg")
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/G+Iso+IsoFr/umap_annot.jpeg", plot = last_plot(), device = "jpeg", width = 10, height = 10)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/G+isoFr/cluster_tree.jpeg", plot = last_plot(), device = "jpeg", width = 10 , height = 10, dpi = 300)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/G+isoFr/umap_res_2.jpeg", plot = last_plot(), device = "jpeg")

plot <- DimPlot(seu_1, reduction = 'gene.fr.umap', group.by = 'active.ident', label = FALSE, repel = TRUE, alpha = 0.5) 

ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/G+isoFr/umap_annot_res.2.jpeg", plot = last_plot(), device = "jpeg",  height = 10, width = 10)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/iso+isoFr/cluster_tree.jpeg", plot = last_plot(), device = "jpeg", width = 10 , height = 10, dpi = 300)
...
ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/iso+isoFr/umap_res.1.6_2.jpeg", plot = last_plot(), device = "jpeg")

plot <- DimPlot(seu_1, reduction = 'iso.fr.umap', group.by = 'active.ident', label = FALSE, repel = TRUE, alpha = 0.3) 

ggsave("~/Documents/DTU_courses/Special_courses/DTU_Health/images/iso+isoFr/umap_annot_res.2.jpeg", plot = last_plot(), device = "jpeg")
